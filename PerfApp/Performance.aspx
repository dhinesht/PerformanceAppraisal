<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Performance.aspx.cs" Inherits="PerfApp.Performance" %>
...
<body>
    ...
    <div class="grid_7">
        ...
        <asp:Button ID="CancelEditButton" runat="server" Text="Cancel" 
            CssClass="button_100" />
        <asp:Button ID="SaveStatsButton" runat="server" Text="Save Stats" 
            CssClass="button_100" />
            <asp:Button ID="DeletePetButton" runat="server" Text="Delete Pet" 
            CssClass="button_100" />
    </div>
    <div class="grid_9">
        <div id="PhotoPanel" runat="server" visible="false">
            ...
            <div class="pet_details_photo_wrapper">
                ...
                <div class="form_line">
                    ...
                    <asp:Button CssClass="button_100" ID="UploadButton" runat="server" 
                        Text="Upload" />
                </div>
            </div>
            <h4>
